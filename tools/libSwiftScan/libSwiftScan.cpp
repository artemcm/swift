...
void swiftscan_diagnostic_dispose(swiftscan_diagnostic_info_t diagnostic) {
  ...
  swiftscan_source_location_dispose(diagnostic->source_location);
  delete diagnostic;
}
...
void swiftscan_source_location_dispose(swiftscan_source_location_t source_location) {
  if (source_location) {
    swiftscan_string_dispose(source_location->buffer_identifier);
