...
SerializedModuleLoaderBase::getModuleImportsOfModule(Twine modulePath,
...
llvm::ErrorOr<ModuleDependencyInfo> SerializedModuleLoaderBase::scanModuleFile(
  ...
  //       optional.
  ModuleLoadingBehavior transitiveLoadingBehavior = ModuleLoadingBehavior::Required;
  auto importedModuleNames =
      getModuleImportsOfModule(modulePath,
                               transitiveLoadingBehavior,
                               isFramework,
