...
struct ScannerMetrics {
  ...
  /// Number of discovered Swift module dependencies
  std::atomic<uint32_t> RecordedSwiftModuleDependencies;
...
private:
  ...
  ///
  void emitScanMetrics(std::shared_ptr<ScannerMetrics> metrics) const;
