// NSErrorDomain across the slice arrangements that matter, with Foundation
// available so that the _BridgedStoredNSError wrapper actually forms and shows
// up in the printed interface.
//
