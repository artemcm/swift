...
// CHECK-REMARK-SAVE: remark: Number of recorded by-name Clang module dependencies: '6'
...
// FIXME: Today, we do not serialize dependencies of the main source module which results in a lookup for 'C'.
// CHECK-REMARK-LOAD: remark: Number of named Clang module queries: '1'
// CHECK-REMARK-LOAD: remark: Number of recorded Swift module dependencies: '0'
// CHECK-REMARK-LOAD: remark: Number of recorded by-name Clang module dependencies: '0'
