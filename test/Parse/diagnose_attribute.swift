...
@warn(ExistentialAny, as: ignored, reason: BadReason) // expected-warning {{'@warn' has been renamed to '@diagnose'}} expected-error {{expected string literal in 'diagnose' attribute}}
func warnAliasCorge() {}
